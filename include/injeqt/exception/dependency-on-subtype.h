 ...
 */
class INJEQT_API dependency_on_subtype : public invalid_dependency
{

public:
	explicit dependency_on_subtype(std::string what = std::string{});
	virtual ~dependency_on_subtype();

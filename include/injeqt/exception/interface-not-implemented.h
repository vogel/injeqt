 ...
 */
class INJEQT_API interface_not_implemented : public exception
{

public:
	explicit interface_not_implemented(std::string what = std::string{});
	virtual ~interface_not_implemented();

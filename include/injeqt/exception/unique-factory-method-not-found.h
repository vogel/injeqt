 ...
 */
class INJEQT_API unique_factory_method_not_found : public exception
{

public:
	explicit unique_factory_method_not_found(std::string what = std::string{});
	virtual ~unique_factory_method_not_found();

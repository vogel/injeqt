 ...
 */
class INJEQT_API unresolvable_dependencies : public exception
{

public:
	explicit unresolvable_dependencies(std::string what = std::string{});
	virtual ~unresolvable_dependencies();

...
dependencies_test::dependencies_test() :
	...
	injectable_type3_type{make_validated_type<injectable_type3>()},
	valid_injected_type_type{make_validated_type<valid_injected_type>()},
	inheriting_valid_injected_type_type{make_validated_type<inheriting_valid_injected_type>()},
	valid_injected_type_with_common_superclass_type{make_validated_type<valid_injected_type_with_common_superclass>()},
	zero_parameters_type_type{make_validated_type<zero_parameters_invalid_injected_type>()},
	too_many_parameters_invalid_injected_type_type{make_validated_type<too_many_parameters_invalid_injected_type>()},
	non_qobject_invalid_injected_type_type{make_validated_type<non_qobject_invalid_injected_type>()},
	duplicate_dependency_invalid_injected_type_type{make_validated_type<duplicate_dependency_invalid_injected_type>()},
	invalid_injected_type_with_superclass_type{make_validated_type<invalid_injected_type_with_superclass>()},
	invalid_injected_type_with_superclass_inverted_type{make_validated_type<invalid_injected_type_with_superclass_inverted>()},
	invalid_injected_type_depends_on_self_type{make_validated_type<invalid_injected_type_depends_on_self>()},
	invalid_injected_type_depends_on_subtype_type{make_validated_type<invalid_injected_type_depends_on_subtype>()},
	invalid_injected_type_depends_on_supertype_type{make_validated_type<invalid_injected_type_depends_on_supertype>()},

...
{
	auto implements = injeqt::details::implements_extractor{}.extract_implements(QObject::staticMetaObject);
	QCOMPARE(implements.size(), 0UL);
}

void test_implements_extractor::should_find_one_in_direct_successor()
{
	auto implements = injeqt::details::implements_extractor{}.extract_implements(direct_successor::staticMetaObject);
...
{
	auto implements = injeqt::details::implements_extractor{}.extract_implements(indirect_successor_1::staticMetaObject);
...
{
	auto implements = injeqt::details::implements_extractor{}.extract_implements(indirect_successor_2::staticMetaObject);
